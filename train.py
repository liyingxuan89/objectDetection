...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/sensor.yaml', help='*.data path')
    ...
    parser.add_argument('--name', default='yolov5x_sensor', help='renames results.txt to results_name.txt if supplied')
