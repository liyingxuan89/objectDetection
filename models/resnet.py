    ...
    for epoch in range(num_epochs):
        ...
        for phase in ["train", "val"]:
            ...
            if phase == "val" and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(best_model_wts, "../weights/resnet101_damper.pt")
...
optimizer_ft = optim.SGD(model_ft.parameters(), lr=.001, momentum=0.9)
